...
import { LogOut, Settings, User, Bell, ArrowRight, CheckCircle, BarChart3, Shield } from "lucide-react";
...
export default function VerifierHome() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #F3E5F5 0%, #EDE7F6 50%, #E1BEE7 100%)",
      }}
    >
      {/* Header */}
      ...
      <section className="py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <div ref={cardsRef} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              { title: "Pending Reviews", icon: "📋" },
              { title: "Verified List", icon: "✅" },
        ...
        <div className="max-w-4xl mx-auto" ref={statsRef}>
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="stat-item text-center p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/50">
              ...
              <p className="text-2xl md:text-3xl font-bold text-gray-800">152</p>
              <p className="text-sm text-gray-500 mt-1">Verified Providers</p>
            </div>
            <div className="stat-item text-center p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/50">
              <Shield className="w-8 h-8 mx-auto mb-3 text-purple-600" />
              <p className="text-2xl md:text-3xl font-bold text-gray-800">94.8%</p>
