...
import { LogOut, Settings, User, Bell, ArrowRight, Briefcase, TrendingUp, Award } from "lucide-react";
...
export default function ProviderHome() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #E8F5E9 0%, #F1F8E9 50%, #C8E6C9 100%)",
      }}
    >
      {/* Header */}
        ...
        <div className="max-w-4xl mx-auto" ref={statsRef}>
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="stat-item text-center p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/50">
              ...
              <p className="text-2xl md:text-3xl font-bold text-gray-800">48</p>
              <p className="text-sm text-gray-500 mt-1">Completed</p>
            </div>
            <div className="stat-item text-center p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/50">
              <Award className="w-8 h-8 mx-auto mb-3 text-green-600" />
              <p className="text-2xl md:text-3xl font-bold text-gray-800">₹24.5K</p>
